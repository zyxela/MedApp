...
@Composable
fun ActionButton(width: Int, text: String, onClick: () -> Unit) {
    Box(modifier = Modifier.padding(3.dp)) {
        ...
        Button(
            modifier = Modifier
                .width(width.dp),
            colors = ButtonDefaults.buttonColors(Lime500),
            shape = RoundedCornerShape(25),
            onClick = onClick
        ) {

            Text(fontFamily = FontFamily(Font(R.font.sofia_sans)), text = text, fontSize = 18.sp)
